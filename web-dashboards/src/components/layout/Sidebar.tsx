...
const NAV: NavItem[] = [
  ...
  { label: 'Orders',      to: '/orders',       icon: <ShoppingCart size={18} />,   roles: ['super_admin', 'sales', 'warehouse_staff', 'warehouse_manager', 'packing_staff'] },
  { label: 'Inventory',   to: '/inventory',    icon: <Package size={18} />,        roles: ['super_admin', 'warehouse_staff', 'warehouse_manager', 'qc_engineer', 'product_manager', 'packing_staff', 'placement_staff'] },
  { label: 'Catalog Images', to: '/catalog-images', icon: <Images size={18} />,    roles: ['super_admin', 'product_manager'] },
  { label: 'QC',          to: '/qc',           icon: <ClipboardCheck size={18} />, roles: ['super_admin', 'warehouse_staff', 'qc_engineer'] },
  { label: 'Bins',        to: '/bins',         icon: <Boxes size={18} />,          roles: ['super_admin', 'warehouse_staff', 'warehouse_manager', 'placement_staff'] },
    ...
    <>
      ...
      >
        ...
        <div className="border-b border-navy-600">
          <div className="bg-white h-36 px-4 py-3 flex items-center justify-center overflow-hidden shadow-md shadow-black/20">
            <img src="/DX_Empire_Crown_Logo.png" alt="DXEmpire Admin Panel" className="max-h-full max-w-full object-contain" />
          </div>
        </div>
